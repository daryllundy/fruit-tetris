...
- [ ] 1. Add starting level selector UI to main menu
...
- [ ] 2. Implement starting level persistence
...
- [ ] 3. Modify TetrisGame class to accept starting level
...
- [ ] 4. Wire up UI events in TetrisApp
...
- [ ]* 6. Write unit tests for edge cases and specific scenarios
  ...
  - Test selector min/max attributes are correct
  - Test starting at level 10 and clearing 10 lines advances to level 11
  - Test game over screen displays both starting and final level
  - _Requirements: 2.3, 2.5, 3.1, 3.2, 3.3, 3.4, 5.4, 5.5_

- [ ] 7. Add starting level display to game over screen
